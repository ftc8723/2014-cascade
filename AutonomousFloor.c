...
#pragma config(Motor,  mtr_S1_C1_1,     leftMotor,     tmotorTetrix, openLoop, reversed, driveLeft, encoder)
#pragma config(Motor,  mtr_S1_C1_2,     rightMotor,    tmotorTetrix, openLoop, driveRight, encoder)
...
void autonomous()
{
	...
	if(SensorValue(IRSeeker) == 4){//4 irl
		//red facing
		irTurnTo('r', 2);
		driveForward(2000);
	}
	else if(SensorValue(IRSeeker) == 5){//5 irl
		//in the middle
		irTurnTo('r', 1);
		driveForward(1400);
		turnFor('l', 1200);
